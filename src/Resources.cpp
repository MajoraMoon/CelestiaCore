...
unsigned char *loadImage(const char *filePath, int *width, int *height, bool flipHorizontally, bool flipVertically)
{
    ...
    *height = surface->h;
    ...
    size_t dataSize = (*width) * (*height) * (SDL_BITSPERPIXEL(surface->format) / 8);
